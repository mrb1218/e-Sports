...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { league_name: @league.league_name, prize_money: @league.prize_money } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { league_name: @league.league_name, prize_money: @league.prize_money } }
